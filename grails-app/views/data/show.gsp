            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="data.message.label" default="Message" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: dataInstance, field: "message")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="data.frequency.label" default="Frequency" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: dataInstance, field: "frequency")}</td>
